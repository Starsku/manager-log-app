...
// ==================================================================================
// 🔒 CONFIGURATION SÉCURISÉE & ROBUSTE 🔒
// ==================================================================================
...
const getEnv = (key) => {
  try {
    ...
    console.warn("Lecture .env impossible dans cet environnement");
    return "";
  }
};
...
// Initialisation avec gestion d'erreur et mode robuste
let app, auth, db;
let initError = null;

try {
    // On vérifie la présence de la clé API avant d'initialiser
    if (firebaseConfig.apiKey) {
        app = initializeApp(firebaseConfig);
        auth = getAuth(app);
        
        // ✅ LE FIX QUI A FAIT MARCHER LE TEST :
        // Force le mode HTTP classique (Long Polling) pour traverser les pare-feu
        db = initializeFirestore(app, {
            experimentalForceLongPolling: true, 
            useFetchStreams: false,
        });
    } else {
        initError = "Configuration manquante. Vérifiez votre fichier .env";
    }
} catch (e) {
    initError = "Erreur Firebase: " + e.message;
    console.error(e);
}
